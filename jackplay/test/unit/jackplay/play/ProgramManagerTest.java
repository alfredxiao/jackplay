...
public class ProgramManagerTest {
    ...
    public void shouldAddTrace() {
        ProgramManager pm = new ProgramManager();
        pm.addAgenda(TRACE, new PlayGround("a.b.c()"), null);
    ...
    public void shouldAddRedefinition() {
        ProgramManager pm = new ProgramManager();
        pm.addAgenda(REDEFINE, new PlayGround("a.b.c()"), "newsource");
    ...
    public void shouldNotAddExistingPlayForTracingButAlwaysAddForRedefinition() {
        ...
        assertTrue(pm.addAgenda(REDEFINE, new PlayGround("a.b.c()"), "newsource"));
        assertFalse(pm.addAgenda(TRACE, new PlayGround("a.b.c()"), null));
    }
    ...
    public void shouldRemoveExistingPlay() {
        ...
        assertTrue(pm.removeAgenda(REDEFINE, new PlayGround("a.b.c()")));
    }
    ...
    public void shouldNotRemoveNoneExistingPlay() {
        ...
        assertFalse(pm.removeAgenda(TRACE, new PlayGround("a.b.c()")));
    }

    @Test
    public void shouldFilterAgendaForClass() {
        ProgramManager pm = new ProgramManager();
        pm.addAgenda(REDEFINE, new PlayGround("a.b.c()"), "body1");
        pm.addAgenda(TRACE, new PlayGround("a.b.c()"), null);
        pm.addAgenda(TRACE, new PlayGround("a.b.d()"), null);
        pm.addAgenda(REDEFINE, new PlayGround("a.dd.c()"), "body2");
        pm.addAgenda(TRACE, new PlayGround("a.dd.c()"), null);
